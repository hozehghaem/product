            ...
            <div class="col-lg-8 mr-auto">
                <div class="breadcrumb-content">
                    <ul class="generic-list-item generic-list-item-arrow d-flex flex-wrap align-items-center">
                        ...
                        <li><a href="{{route('آرشیو-ویدئو')}}">آرشیو ویدئو ها</a></li>
                        <li><a href="#">{{$blugs->title}}</a></li>
                    </ul>
                    <div class="section-heading">
                        <h2 class="section__title">{{$blugs->title}}</h2>
                        <p class="section__desc pt-2 lh-30">{{$blugs->description}}</p>
                    </div>
...
{{--                        <h6 class="ribbon ribbon-lg mr-2 bg-3 text-white">دوره ممتاز</h6>--}}
                        <div class="rating-wrap d-flex flex-wrap align-items-center">
                            ...
                            <span class="student-total pl-2">56 بازدید</span>
                        </div>
                    </div>
                    ...
                    <div class="d-flex flex-wrap align-items-center">
                        <p class="pr-3 d-flex align-items-center">
                            ...
                            آخرین به روز رسانی
                            {{jdate($blugs->update_at)->format('d %B Y')}}
                        </p>
                        <p class="pr-3 d-flex align-items-center">
                            <svg class="svg-icon-color-gray mr-1" width="16px" viewBox="0 0 24 24">
            ...
            <div class="row">
                <div class="col-lg-8 pb-5">
                    <div class="course-details-content-wrap pt-90px">
                        <div class="course-overview-card bg-gray p-4 rounded">
                            <h3 class="fs-24 font-weight-semi-bold pb-3">{{$video->title_text}}</h3>
                            <ul class="generic-list-item overview-list-item">
                                <li><i class="la la-check mr-1 text-black"></i>{{$video->item1}}</li>
                                <li><i class="la la-check mr-1 text-black"></i>{{$video->item2}}</li>
                                <li><i class="la la-check mr-1 text-black"></i>{{$video->item3}}</li>
                                <li><i class="la la-check mr-1 text-black"></i>{{$video->item4}}</li>
                                <li><i class="la la-check mr-1 text-black"></i>{{$video->item5}}</li>
                                <li><i class="la la-check mr-1 text-black"></i>{{$video->item6}}</li>
                            </ul>
                        </div>
                ...
                <div class="col-lg-4">
                    <div class="sidebar sidebar-negative">
                            ...
                            <div class="card-body">
                                <div class="preview-course-video">
                                    <a href="javascript:void(0)" data-toggle="modal" data-target="#previewModal">
                                        <img src="{{asset('storage/'.$video->cover)}}" data-src="{{asset('storage/'.$video->cover)}}" alt="{{$video->title}}" class="w-100 rounded lazy" />
                                        <div class="preview-course-video-content">
                                            ...
                                            <p class="fs-15 font-weight-bold text-white pt-3">پخش فایل ویدئو</p>
                                        </div>
                                    </a>
                                </div>
                            </div>
                        ...
                        <div class="card card-item">
                            <div class="card-body">
                                <h3 class="card-title fs-18 pb-2">ویژگی های فایل ویدئو</h3>
                                <div class="divider"><span></span></div>
                                <ul class="generic-list-item generic-list-item-flash">
                                    <li class="d-flex align-items-center justify-content-between">
                                        <span><i class="la la-clock mr-2 text-color"></i>مدت زمان</span>1:15
                                    </li>
                                    <li class="d-flex align-items-center justify-content-between">
                                        <span><i class="la la-play-circle-o mr-2 text-color"></i>نوع</span> سخنرانی
                                    </li>
                                    <li class="d-flex align-items-center justify-content-between">
    ...
    <div class="modal fade" id="previewModal" tabindex="-1" role="dialog" aria-labelledby="previewModalTitle" aria-hidden="true">
        <div class="modal-dialog modal-xl modal-dialog-centered" role="document">
            <div class="modal-content">
                <video controls preload="metadata" poster="{{asset('storage/'.$video->cover)}}" id="player" style="width: 100%">
                        ...
                        <div class="card card-item card-preview" data-tooltip-content="#tooltip_content_1">
                            <div class="card-image">
                                <a href="{{url('آرشیو-ویدئو/'.$video->slug)}}" class="d-block">
                                    <img class="card-img-top img-index" src="{{asset('storage/'.$video->cover)}}" alt="{{$video->title}}">
                                    <div class="play-button">
                            ...
                            <div class="card-body">
                                ...
                                <div class="rating-wrap d-flex align-items-center justify-content-between pt-3">
                                    <p>{{jdate($video->created_at)->format('d %B Y')}}</p>
                                    <a href="{{url('آرشیو-ویدئو/'.$video->slug)}}" class="btn theme-btn theme-btn-sm theme-btn-transparent">مشاهده</a>
                                </div>
                            </div>
                        </div>
                    @endforeach
