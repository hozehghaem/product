            ...
            <div class="breadcrumb-content">
                <div class="media media-card align-items-center pb-4">
                    <div class="media-body">
                        <h2 class="section__title fs-30">آرشیو کلیپ های ویدئویی </h2>
        ...
        <div class="container">
            <div class="filter-bar mb-4">
                <div class="filter-bar-inner d-flex flex-wrap align-items-center justify-content-between">
                    <p class="fs-14"> تعداد <span class="text-black"> {{$count}} </span> کلیپ ویدئویی در دسترس </p>
                    ...
                    <div class="col-lg-4 responsive-column-half">
                        <div class="card card-item">
                            <div class="card-image">
                                <a href="{{url('آرشیو-ویدئو/'.$video->slug)}}">
                                    <img class="card-img-top lazy" src="{{asset('storage/'.$video->cover)}}" data-src="{{asset('storage/'.$video->cover)}}" alt="{{$video->title}}" />
