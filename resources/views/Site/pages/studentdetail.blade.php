            ...
            <div class="breadcrumb-content">
                <div class="media media-card align-items-center pb-4">
                    <div class="media-img media--img media-img-md rounded-full">
                        <img class="rounded-full lazy" src="images/img-loading.png" data-src="images/small-avatar-1.jpg" alt="تصویر کوچک دانش آموز" />
                    </div>
                    <div class="media-body">
                        <h2 class="section__title fs-30">محمد حسین دیوان بیگی</h2>
                        <span class="d-block lh-18 pt-1 pb-2">6 ماه پیش</span>
                        <p class="lh-18">کارشناس ارشد توسعه نرم افزار</p>
                    </div>
                </div>
    ...
    <section class="teacher-details-area pt-50px">
        <div class="container">
            <div class="student-details-wrap pb-20px">
                <h3 class="fs-24 font-weight-semi-bold pb-2">بیوگرافی</h3>
                <p class="pb-5">
                    ...
                    با هدف بهبود ابزارهای کاربردی می باشد. دورههای زیادی در شصت و سه درصد گذشته، حال و آینده شناخت فراوان جامعه و متخصصان را می طلبد
                </p>
                <div class="row">
                    <div class="col-lg-4 responsive-column-half">
                        <div class="counter-item">
                            ...
                            <p class="counter__meta">دوره مشاهده شد</p>
                        </div>
                    ...
                    <div class="col-lg-4 responsive-column-half">
                        <div class="counter-item">
                            <div class="counter__icon icon-element mb-3 shadow-sm">
                                <svg class="svg-icon-color-3" width="40" viewBox="0 0 512.007 512.007" xmlns="http://www.w3.org/2000/svg">
                                    <g>
                                        <path
        ...
        <div class="bg-gray py-5">
            <div class="container">
                <ul class="nav nav-tabs generic-tab justify-content-center" id="myTab" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" id="my-learning-tab" data-toggle="tab" href="#my-learning" role="tab" aria-controls="my-learning" aria-selected="false">
                            یادگیری من
                        </a>
                    </li>
                    <li class="nav-item">
                                    ...
                                    <div class="col-lg-4 responsive-column-half">
                                        <div class="card card-item card-preview" data-tooltip-content="#tooltip_content_1">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <p class="card-text"><a href="teacher-detail.html">استاد محمدباقر حیری کاشانی</a></p>
