            ...
            <div class="col-lg-12">
                <div class="breadcrumb-content d-flex flex-wrap align-items-center justify-content-between">
                    <div class="section-heading">
                        <h2 class="section__title text-white">سوالات متداول</h2>
                    </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="feature-heading-content-wrap text-center">
                    <div class="section-heading">
                        <h2 class="section__title pb-3">یک موضوع را برای راهنما انتخاب کنید</h2>
                        <p class="section__desc">سپس از شما می&zwnj;خواهیم سطح فعلی خود را به ما بگویید یا از شما دعوت می&zwnj;کنیم تا در <br>
                            آزمون سریع 20 دقیقه&zwnj;ای ما شرکت کنید تا مطمئن شویم که شروع به یادگیری  می&zwnj;کنید.</p>
            ...
            <div class="col-lg-4 responsive-column-half">
                <a href="#" class="card card-item rounded--pill hover-s">
                    <div class="card-body d-flex align-items-center">
                        ...
                        <div class="pl-4">
                            <h5 class="card-title fs-18">شروع شدن</h5>
                            <p class="card-text text-gray">چگونه یادگیری را شروع کنیم</p>
                        </div>
                    </div><!-- end card-body -->
                </a><!-- end card -->
            </div><!-- end col-lg-4 -->
            <div class="col-lg-4 responsive-column-half">
                <a href="#" class="card card-item rounded--pill hover-s">
                    <div class="card-body d-flex align-items-center">
                        ...
                        <div class="pl-4">
                            <h5 class="card-title fs-18">حساب / نمایه</h5>
                            <p class="card-text text-gray">حساب کاربری خود را مدیریت کنید</p>
                        </div>
                    </div><!-- end card-body -->
                </a><!-- end card -->
            </div><!-- end col-lg-4 -->
            <div class="col-lg-4 responsive-column-half">
                <a href="#" class="card card-item rounded--pill hover-s">
                    <div class="card-body d-flex align-items-center">
                        ...
                        <div class="pl-4">
                            <h5 class="card-title fs-18">برنامه های دوره</h5>
                            <p class="card-text text-gray">همه چیز در مورد گرفتن</p>
                        </div>
                    </div><!-- end card-body -->
                </a><!-- end card -->
            </div><!-- end col-lg-4 -->
            <div class="col-lg-4 responsive-column-half">
                <a href="#" class="card card-item rounded--pill hover-s">
                    <div class="card-body d-flex align-items-center">
                        ...
                        <div class="pl-4">
                            <h5 class="card-title fs-18">عیب یابی</h5>
                            <p class="card-text text-gray">تجربه یک باگ؟</p>
                        </div>
                    </div><!-- end card-body -->
                </a><!-- end card -->
            </div><!-- end col-lg-4 -->
            <div class="col-lg-4 responsive-column-half">
                <a href="#" class="card card-item rounded--pill hover-s">
                    <div class="card-body d-flex align-items-center">
                        ...
                        <div class="pl-4">
                            <h5 class="card-title fs-18">اپلیکیشن موبایل</h5>
                            <p class="card-text text-gray">درباره برنامه ما بیاموزید</p>
                        </div>
                    </div><!-- end card-body -->
                </a><!-- end card -->
            </div><!-- end col-lg-4 -->
            <div class="col-lg-4 responsive-column-half">
                <a href="#" class="card card-item rounded--pill hover-s">
                    <div class="card-body d-flex align-items-center">
                        ...
                        <div class="pl-4">
                            <h5 class="card-title fs-18">خرید/بازپرداخت</h5>
                            <p class="card-text text-gray">با کوپن ها آشنا شوید</p>
                        </div>
                    </div><!-- end card-body -->
                </a><!-- end card -->
            </div><!-- end col-lg-4 -->
        ...
        <div class="row">
                    ...
                    <div class="card">
                        <div class="card-header" id="headingTwo">
                            <button class="btn btn-link collapsed" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                                <i class="la la-plus"></i>
                                <i class="la la-minus"></i>
                                چگونه می توانم بازپرداخت دریافت کنم؟
                            </button>
                        </div>
                    ...
                    <div class="card">
                        <div class="card-header" id="headingEight">
                            <button class="btn btn-link collapsed" data-toggle="collapse" data-target="#collapseEight" aria-expanded="false" aria-controls="collapseEight">
                                <i class="la la-plus"></i>
                                <i class="la la-minus"></i>
                                الزامات مهارت زبان انگلیسی چیست؟
                            </button>
                        </div>
            ...
            <div class="col-lg-5">
                <div class="card card-item">
                    <div class="card-body">
                        <h3 class="fs-24 font-weight-semi-bold pb-2">هنوز سوالی دارید؟</h3>
                        ...
                        <form method="post">
                            ...
                            <div class="input-box">
                                ...
                                <div class="form-group">
                                    <input class="form-control form--control" type="email" name="email" placeholder="ایمیل شما">
                            ...
                            <div class="input-box">
                                ...
                                <div class="form-group">
                                    <input class="form-control form--control" type="text" name="text" placeholder="دلیل تماس">
                            ...
                            <div class="input-box">
                                ...
                                <div class="form-group">
                                    <textarea class="form-control form--control pl-4" name="message" rows="6" placeholder="پیام "></textarea>
                                </div>
                            </div><!-- end input-box -->
                            <div class="btn-box pt-2">
                                <button class="btn theme-btn" type="submit">ارسال پیام <i class="la la-arrow-left icon ml-1"></i></button>
                            </div><!-- end btn-box -->
                        </form>
                    </div><!-- end card-body -->
                </div><!-- end card -->
