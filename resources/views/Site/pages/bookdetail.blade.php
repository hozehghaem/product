                ...
                <div class="breadcrumb-content">
                    ...
                    <div class="d-flex flex-wrap align-items-center pt-3">
                        ...
                        <div class="rating-wrap d-flex flex-wrap align-items-center">
                            ...
                            <span class="rating-total pl-1">(230 رای کاربران) </span>
                            <span class="student-total pl-2">5,815 بازدید</span>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-lg-8 pb-5">
                    <div class="course-details-content-wrap pt-90px">
                        ...
                        <div class="course-overview-card pt-4">
                            <h3 class="fs-24 font-weight-semi-bold pb-4">ثبت نظرات</h3>
                            ...
                            <div class="card-body">
                                <div class="preview-course-video">
                                    <a href="javascript:void(0)" data-toggle="modal" data-target="#previewModal">
                                        <img src="{{asset($video->cover)}}" data-src="{{asset($video->cover)}}" alt="{{$video->title}}" class="w-100 rounded lazy" />
                            ...
                            <div class="card-body">
                                ...
                                <ul class="generic-list-item generic-list-item-flash">
                                    <li class="d-flex align-items-center justify-content-between">
                                        <span><i class="la la-clock mr-2 text-color"></i>مدت زمان</span> 25 دقیقه
                                    </li>
                                    <li class="d-flex align-items-center justify-content-between">
                        ...
                        <div class="card card-item card-preview" data-tooltip-content="#tooltip_content_1">
                            <div class="card-image">
                                <a href="{{url('آرشیو-ویدئو/'.$video->slug)}}" class="d-block">
                                    <img class="card-img-top img-index" src="{{asset($video->cover)}}" alt="{{$video->title}}">
                                    <div class="play-button">
