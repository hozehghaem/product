            ...
            <div class="container">
                <div class="breadcrumb-content d-flex flex-wrap align-items-center justify-content-between">
                    <div class="section-heading">
                        <h2 class="section__title text-white">معلمان</h2>
                    </div>
        ...
        <section class="team-member-area section-padding">
            <div class="container">
                <div class="row">
                    <div class="col-lg-3 responsive-column-half">
                        <div class="card card-item member-card text-center">
                            ...
                            <div class="card-body">
                                <h5 class="card-title"><a href="teacher-detail.html">الکس اسمیت</a></h5>
                                <p class="card-text">معلم</p>
                                <a href="teacher-detail.html" class="btn theme-btn theme-btn-sm theme-btn-transparent mt-3">مشاهده نمایه <i class="la la-arrow-left icon ml-1"></i></a>
                            </div>
                        </div>
                        <!-- end card -->
                    </div>
                    ...
                    <div class="col-lg-3 responsive-column-half">
                        <div class="card card-item member-card text-center">
                            ...
                            <div class="card-body">
                                <h5 class="card-title"><a href="teacher-detail.html">رز تیلور</a></h5>
                                <p class="card-text">معلم</p>
                                <a href="teacher-detail.html" class="btn theme-btn theme-btn-sm theme-btn-transparent mt-3">مشاهده نمایه <i class="la la-arrow-left icon ml-1"></i></a>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-3 responsive-column-half">
                        <div class="card card-item member-card text-center">
                            ...
                            <div class="card-body">
                                <h5 class="card-title"><a href="teacher-detail.html">جف کالین</a></h5>
                                <p class="card-text">معلم</p>
                                <a href="teacher-detail.html" class="btn theme-btn theme-btn-sm theme-btn-transparent mt-3">مشاهده نمایه <i class="la la-arrow-left icon ml-1"></i></a>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-3 responsive-column-half">
                        <div class="card card-item member-card text-center">
                            ...
                            <div class="card-body">
                                <h5 class="card-title"><a href="teacher-detail.html">مایک هاردسون</a></h5>
                                <p class="card-text">معلم</p>
                                <a href="teacher-detail.html" class="btn theme-btn theme-btn-sm theme-btn-transparent mt-3">مشاهده نمایه <i class="la la-arrow-left icon ml-1"></i></a>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-3 responsive-column-half">
                        <div class="card card-item member-card text-center">
                            ...
                            <div class="card-body">
                                <h5 class="card-title"><a href="teacher-detail.html">جان اسمیت</a></h5>
                                <p class="card-text">معلم</p>
                                <a href="teacher-detail.html" class="btn theme-btn theme-btn-sm theme-btn-transparent mt-3">مشاهده نمایه <i class="la la-arrow-left icon ml-1"></i></a>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-3 responsive-column-half">
                        <div class="card card-item member-card text-center">
                            ...
                            <div class="card-body">
                                <h5 class="card-title"><a href="teacher-detail.html">کوین مارتین</a></h5>
                                <p class="card-text">معلم</p>
                                <a href="teacher-detail.html" class="btn theme-btn theme-btn-sm theme-btn-transparent mt-3">مشاهده نمایه <i class="la la-arrow-left icon ml-1"></i></a>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-3 responsive-column-half">
                        <div class="card card-item member-card text-center">
                            ...
                            <div class="card-body">
                                <h5 class="card-title"><a href="teacher-detail.html">تیشام الردی</a></h5>
                                <p class="card-text">معلم</p>
                                <a href="teacher-detail.html" class="btn theme-btn theme-btn-sm theme-btn-transparent mt-3">مشاهده نمایه <i class="la la-arrow-left icon ml-1"></i></a>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-3 responsive-column-half">
                        <div class="card card-item member-card text-center">
                            ...
                            <div class="card-body">
                                <h5 class="card-title"><a href="teacher-detail.html">آلپر دوئین</a></h5>
                                <p class="card-text">معلم</p>
                                <a href="teacher-detail.html" class="btn theme-btn theme-btn-sm theme-btn-transparent mt-3">مشاهده نمایه <i class="la la-arrow-left icon ml-1"></i></a>
                            </div>
                        </div>
                ...
                <div class="load-more-btn-box pt-3 text-center">
                    <a href="#" class="btn theme-btn"><i class="la la-refresh mr-1"></i> بارگذاری بیشتر</a>
                </div>
            </div>
            <!-- end container -->
        </section>
                ...
                <div class="row align-items-center">
                    <div class="col-lg-9">
                        <div class="cta-content-wrap media py-4 align-items-center">
                            <div class="flex-shrink-0 mr-3">
                                <svg class="svg-icon-color-gray" width="80" viewBox="0 -48 496 496" xmlns="http://www.w3.org/2000/svg">
                                    <path
                            ...
                            <div class="media-body">
                                <h2 class="fs-25 font-weight-bold mb-1">معلم شوید، دانش خود را به اشتراک بگذارید</h2>
                    ...
                    <div class="col-lg-3">
                        <div class="cta-btn-box text-left">
                            <a href="become-a-teacher.html" class="btn theme-btn">فناوری در آدوکا <i class="la la-arrow-left icon ml-1"></i></a>
                        </div>
                    </div>
                    <!-- end col-lg-3 -->
                </div>
