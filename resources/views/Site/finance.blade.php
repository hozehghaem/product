    ...
    <div class="container my-4">
        ...
        <div class="row py-4 align-items-center">
            ...
            <div class="col-md-6 mb-4">
                <img src="{{asset('/site/img/media/mahdia1.jpg')}}" class="img-fluid" alt="تصویر مهدیا 1">
            </div>
            <div class="col-md-6 mb-4">
        ...
        <div class="row py-8 align-items-center">
            ...
            <div class="col-md-6 mb-4 order-md-2">
                <img src="{{asset('/site/img/media/mahdia2.jpg')}}" class="img-fluid float-left" alt="تصویر قرض الحسنه 2" >
            </div>
        ...
        <div class="row py-4 align-items-center">
            ...
            <div class="col-md-6 mb-4">
                <h3 class="text-center text-md-right pb-4">وام قرض الحسنه</h3>
                <p>لورم ایپسوم به سادگی ساختار چاپ و متن را در بر می گیرد.
                    لورم ایپسوم به مدت 40 سال استاندارد صنعت بوده است. لورم
                    ایپسوم به سادگی ساختار چاپ و متن را در بر می گیرد.
                    لورم ایپسوم به سادگی ساختار چاپ و متن را در بر می گیرد.
                    لورم ایپسوم به مدت 40 سال استاندارد صنعت بوده است. لورم
                    ایپسوم به سادگی ساختار چاپ و متن را در بر می گیرد.
                    لورم ایپسوم به مدت 40 سال استاندارد صنعت بوده است.لورم ایپسوم به مدت 40 سال استاندارد صنعت بوده است.</p>
            </div>
        </div>
        <div class="row mb-8">
            <!-- اطلاعات تماس -->
