...
@section('main')
            <div class="dashboard-heading mb-5">
                <h3 class="fs-22 font-weight-semi-bold">درآمد</h3>
            </div>
            ...
            <div class="tab-content" id="myTabContent">
                    ...
                    <div class="row">
                        <div class="col-lg-4 responsive-column-half">
                            <div class="card card-item dashboard-info-card">
                                <div class="card-body d-flex align-items-center">
                                    ...
                                    <div class="pl-4">
                                        <p class="card-text fs-18">موجودی من</p>
                        ...
                        <div class="col-lg-4 responsive-column-half">
                            <div class="card card-item dashboard-info-card">
                                <div class="card-body d-flex align-items-center">
                                    ...
                                    <div class="pl-4">
                                        <p class="card-text fs-18">درآمد من</p>
                                        <h5 class="card-title pt-2 fs-26">2000</h5>
                                    </div>
                                </div><!-- end card-body -->
                            </div><!-- end card -->
                        </div><!-- end col-lg-4 -->
                                                    ...
                                                    <g>
                                                        <g>
                                                            <path d="M406.872,160.017c-0.005,0-0.011,0-0.016,0h-400c-3.782-0.004-6.852,3.058-6.856,6.84c0,0.005,0,0.011,0,0.016v192
                                                                ...
                                                                c3.782,0.004,6.852-3.058,6.856-6.84c0-0.005,0-0.011,0-0.016v-24C413.716,163.091,410.654,160.022,406.872,160.017z"></path>
                                                        </g>
                                                    </g>
                                            <g>
                                                        <g>
                                                            <path d="M360.36,128.185l-320-72c-1.776-0.397-3.637-0.075-5.176,0.896c-1.537,0.979-2.624,2.526-3.024,4.304l-16,72
                                                                ...
                                                                c0.496,0.115,1.003,0.172,1.512,0.168c3.786-0.007,6.85-3.082,6.844-6.868C365.702,131.66,363.482,128.89,360.36,128.185z"></path>
                                                        </g>
                                                    </g>
                                            <g>
                                                        <g>
                                                            <path d="M321.504,88.513l-192-80c-3.337-1.391-7.182,0.038-8.8,3.272l-16,32c-1.807,3.342-0.563,7.517,2.78,9.324
                                                                ...
                                                                c3.504,1.462,7.53-0.192,8.992-3.696C326.662,94.002,325.008,89.976,321.504,88.513z"></path>
                                                        </g>
                                                    </g>
                                            <g>
                                                        <g>
                                                            <path d="M326.352,192.017h-63.496c-3.786,0-6.856,3.07-6.856,6.856c0,3.786,3.07,6.856,6.856,6.856h63.496
                                                                c3.786,0,6.856-3.07,6.856-6.856S330.138,192.017,326.352,192.017z"></path>
                                                        </g>
                                                    </g>
                                            <g>
                                                        <g>
                                                            <path d="M198.856,192.473c-38.881,0-70.4,31.519-70.4,70.4c0.04,38.864,31.536,70.36,70.4,70.4c38.881,0,70.4-31.519,70.4-70.4
                                                                ...
                                                                c31.812,0,57.6,25.788,57.6,57.6C256.456,294.685,230.668,320.473,198.856,320.473z"></path>
                                                        </g>
                                                    </g>
                                            <g>
                                                        <g>
                                                            <path d="M390.856,214.873c-42.4,0-88,10.016-88,32v192c0,21.984,45.6,32,88,32c42.4,0,88-10.016,88-32v-192
                                                                ...
                                                                c1.288-4.456,25.272-16.096,72-16.096c46.4,0,70.4,11.472,72,16C461.256,251.401,437.256,262.873,390.856,262.873z"></path>
                                                        </g>
                                                    </g>
                                            <g>
                                                        <g>
                                                            <path d="M134.856,320.009H74.384l-28.672-31.36v-52l31.664-30.92h57.48c3.786,0,6.856-3.07,6.856-6.856
                                                                ...
                                                                c3.786,0,6.856-3.07,6.856-6.856C141.712,323.079,138.643,320.009,134.856,320.009z"></path>
                                                        </g>
                                                    </g>
                                            <g>
                                                        <g>
                                                            <path d="M202.856,254.873h-8c-2.488,0-4-1.392-4-2c0-0.608,1.512-2,4-2h20c4.418,0,8-3.582,8-8s-3.582-8-8-8h-8
                                                                ...
                                                                c8.873-1.253,15.595-8.648,16-17.6C222.283,262.424,213.349,254.365,202.856,254.873z"></path>
                                                        </g>
                                                    </g>
                                                </svg>
                                    </div>
                                    <div class="pl-4">
                                        <p class="card-text fs-18">فروش تمام وقت</p>
                        ...
                        <div class="col-lg-4 responsive-column-half">
                            <div class="card card-item dashboard-info-card">
                                <div class="card-body d-flex align-items-center">
                                    ...
                                    <div class="pl-4">
                                        <p class="card-text fs-18">هزینه های کسر شده</p>
                                        <h5 class="card-title pt-2 fs-26">65.40</h5>
                                    </div>
                                </div><!-- end card-body -->
                            </div><!-- end card -->
                        </div><!-- end col-lg-4 -->
                        <div class="col-lg-4 responsive-column-half">
                            <div class="card card-item dashboard-info-card">
                                <div class="card-body d-flex align-items-center">
                                    ...
                                    <div class="pl-4">
                                        <p class="card-text fs-18">کمیسیون های کسر شده</p>
                                        <h5 class="card-title pt-2 fs-26">51.00</h5>
                                    </div>
                                </div><!-- end card-body -->
                            </div><!-- end card -->
                        </div><!-- end col-lg-4 -->
                        <div class="col-lg-4 responsive-column-half">
                            <div class="card card-item dashboard-info-card">
                                <div class="card-body d-flex align-items-center">
                                    ...
                                    <div class="pl-4">
                                        <p class="card-text fs-18">هزینه های کسر شده</p>
                                        <h5 class="card-title pt-2 fs-26">60.00</h5>
                                    </div>
                                </div><!-- end card-body -->
                            </div><!-- end card -->
                        </div><!-- end col-lg-4 -->
                        <div class="col-lg-6 responsive-column-half">
                            <div class="card card-item">
                                <div class="card-body">
                                    <h3 class="fs-18 font-weight-semi-bold pb-4">نمودار درآمد این ماه </h3>
                                    <canvas id="bar-chart"></canvas>
                                    <ul class="chart-legend mt-40px text-center">
                                        <li>نمودار درآمد این ماه</li>
                                    </ul>
                                </div>
                            </div><!-- end card -->
                        </div><!-- end col-lg-6 -->
                ...
                <div class="tab-pane fade" id="report" role="tabpanel" aria-labelledby="report-tab">
                    <div class="data-list d-flex flex-wrap align-items-center justify-content-between pb-40px">
                        <div class="btn-group btn--group btn-group-toggle flex-wrap" data-toggle="buttons">
                            <label class="btn theme-btn theme-btn-transparent shadow-none fs-15 font-weight-medium">
                                <input type="radio" name="options" id="option1"> سال گذشته
                            </label>
                            <label class="btn theme-btn theme-btn-transparent shadow-none fs-15 font-weight-medium active">
                                <input type="radio" name="options" id="option2" checked=""> امسال
                            </label>
                            <label class="btn theme-btn theme-btn-transparent shadow-none fs-15 font-weight-medium">
                                <input type="radio" name="options" id="option3"> ماه گذشته
                            </label>
                            <label class="btn theme-btn theme-btn-transparent shadow-none fs-15 font-weight-medium">
                                <input type="radio" name="options" id="option4"> هفته گذشته
                            </label>
                            <label class="btn theme-btn theme-btn-transparent shadow-none fs-15 font-weight-medium">
                                <input type="radio" name="options" id="option5"> این هفته
                            </label>
                        </div>
                        <form action="#" class="d-flex align-items-center">
                            <div class="form-group mb-0 flex-shrink-0 mr-2">
                                <span class="la la-calendar-o input-icon"></span>
                                <input data-jdp class="form-control form--control" type="text" value="1400/09/15">
                            </div>
                            <button class="btn theme-btn"><i class="la la-search"></i></button>
                        </form>
                    </div><!-- end data-list -->
                    <div class="row">
                        <div class="col-lg-6 responsive-column-half">
                        ...
                        <div class="col-lg-12">
                            <div class="card card-item">
                                <div class="card-body">
                                    <h3 class="fs-18 font-weight-semi-bold pb-4">داده های درآمد برای سال (2022)</h3>
                                    <canvas id="line-chart-2"></canvas>
                                    <ul class="chart-legend mt-40px text-center">
                                        <li>داده های سود در سال جاری</li>
                                    </ul>
                                </div>
                            </div><!-- end card -->
                        </div><!-- end col-lg-12 -->
                            ...
                            <tr>
                                <th scope="row">
                                    <ul class="generic-list-item pb-3">
                                        <li>
                                            <span class="badge bg-success text-white p-1">تکمیل شد</span>
                                        </li>
                                        <li>
                                            <span class="text-black mr-1">تاریخ:</span> 4 جولای 2022، 11:30 صبح
                                        </li>
                                        <li>
                                            <span class="text-black mr-1">آموزش:</span> ایجاد SVG پاسخگو
                                        </li>
                                        <li>
                                            <span class="text-black mr-1">قیمت:</span> 1000 تومان
                                        </li>
                                        <li>
                                            <span class="text-black mr-1">شناسه سفارش:</span> #090909
                                        </li>
                                    </ul>
                                    <ul class="generic-list-item">
                                        <li>
                                            <span class="text-black font-weight-semi-bold">خریدار</span>
                                        </li>
                                        <li>
                                            <span class="text-black mr-1">نام:</span> کامران عدی
                                        </li>
                                        <li>
                                            <span class="text-black mr-1">آدرس:</span>تهران خیابان اول کوچه دوم پلاک سوم
                                        </li>
                                        <li>
                                            <span class="text-black mr-1">ایمیل:</span> info@gmail.com
                                        </li>
                                    </ul>
                                </th>
                                <td>
                                    <ul class="generic-list-item">
                                        <li class="text-black">1000 تومان</li>
                                        <li>طبق 70.00</li>
                                        <li>(درصد)</li>
                                    </ul>
                                </td>
                                ...
                                <td>
                                    <ul class="generic-list-item">
                                        <li class="text-black">نگهداری</li>
                                        <li class="text-black">هزینه: 1000 تومان</li>
                                        <li>نوع: ثابت</li>
                                    </ul>
                                </td>
                            </tr>
                            <tr>
                                <th scope="row">
                                    ...
                                    <ul class="generic-list-item">
                                        ...
                                        <li>
                                            <span class="text-black mr-1">نام:</span>حسین دیوان بیگی
                                        </li>
                                        <li>
                                            <span class="text-black mr-1">آدرس:</span>تهران خیابان یکم کوچه دوم پلاک 22
                                        </li>
                                        <li>
                                            <span class="text-black mr-1">ایمیل:</span> info@gmail.com
                                        </li>
