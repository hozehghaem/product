    ...
    <div class="row">
        ...
        <div class="col-lg-4 responsive-column-half">
            <div class="card card-item dashboard-info-card">
                <div class="card-body d-flex align-items-center">
                    ...
                    <div class="pl-4">
                        <p class="card-text fs-18">دوره های فعال</p>
        ...
        <div class="col-lg-4 responsive-column-half">
            <div class="card card-item dashboard-info-card">
                <div class="card-body d-flex align-items-center">
                    ...
                    <div class="pl-4">
                        <p class="card-text fs-18">دوره های تکمیل شده</p>
        ...
        <div class="col-lg-4 responsive-column-half">
            <div class="card card-item dashboard-info-card">
                <div class="card-body d-flex align-items-center">
                    ...
                    <div class="pl-4">
                        <p class="card-text fs-18">کل دانش آموزان</p>
        ...
        <div class="col-lg-4 responsive-column-half">
            <div class="card card-item dashboard-info-card">
                <div class="card-body d-flex align-items-center">
                    ...
                    <div class="pl-4">
                        <p class="card-text fs-18">مجموع دوره ها</p>
                        <h5 class="card-title pt-2 fs-26">11</h5>
                    </div>
                </div>
        ...
        <div class="col-lg-4 responsive-column-half">
            <div class="card card-item dashboard-info-card">
                <div class="card-body d-flex align-items-center">
                    ...
                    <div class="pl-4">
                        <p class="card-text fs-18">درآمد کل</p>
        ...
        <div class="col-lg-4 responsive-column-half">
            <div class="card card-item">
                <div class="card-body">
                    <h3 class="fs-18 font-weight-semi-bold pb-4">کل فروش</h3>
        ...
        <div class="col-lg-4 responsive-column-half">
            <div class="card card-item">
                <div class="card-body">
                    <h3 class="fs-18 font-weight-semi-bold pb-4">درآمد خالص</h3>
            ...
            <div class="card card-item">
                <div class="card-body">
                    ...
                    <div class="my-course-progress-bar-wrap">
                        ...
                        <div class="d-flex flex-wrap align-items-center mb-2 position-relative">
                            <p class="skillbar-title">بریتانیا:</p>
                            <div class="skillbar-box">
                        ...
                        <div class="d-flex flex-wrap align-items-center mb-2 position-relative">
                            <p class="skillbar-title">کانادا:</p>
                            <div class="skillbar-box">
                        ...
                        <div class="d-flex flex-wrap align-items-center mb-2 position-relative">
                            <p class="skillbar-title">برزیل:</p>
                            <div class="skillbar-box">
                        ...
                        <div class="d-flex flex-wrap align-items-center mb-2 position-relative">
                            <p class="skillbar-title">روسیه:</p>
                            <div class="skillbar-box">
                        ...
                        <div class="d-flex flex-wrap align-items-center mb-2 position-relative">
                            <p class="skillbar-title">استرالیا:</p>
                            <div class="skillbar-box">
            ...
            <div class="card card-item">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center pb-4">
                        <h3 class="fs-18 font-weight-semi-bold pb-4">آمار درآمد</h3>
                        <div class="select-container w-auto">
                            <select class="select-container-select">
                                <option value="this-week">این هفته</option>
                                <option value="this-month">این ماه</option>
                                <option value="last-months">6 ماه گذشته</option>
                                <option value="this-year">امسال</option>
                            </select>
                        </div>
                    </div>
        ...
        <div class="col-lg-5 responsive-column-half">
            <div class="card card-item">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center pb-4">
                        <h3 class="fs-18 font-weight-semi-bold">اطلاعیه</h3>
                        <span class="fs-15 cursor-pointer">همه را به عنوان خوانده شده علامت بزن</span>
                    </div>
                    <div class="notification-body scrolled-box custom-scrollbar-styled">
                        <a href="{{route('dashboard')}}" class="media media-card align-items-center">
                            ...
                            <div class="media-body">
                                <h5 class="fs-15">رزومه شما به روز شد!</h5>
                        ...
                        <a href="{{route('dashboard')}}" class="media media-card align-items-center">
                            ...
                            <div class="media-body">
                                <h5 class="fs-15">رمز عبور را عوض کردی</h5>
                        ...
                        <a href="{{route('dashboard')}}" class="media media-card align-items-center">
                            ...
                            <div class="media-body">
                                <h5 class="fs-15">حساب شما با موفقیت ایجاد شد</h5>
                                <span class="d-block lh-18 pt-1 text-gray fs-13">12 خرداد 1400</span>
                            </div>
                        </a>
                        <a href="{{route('dashboard')}}" class="media media-card align-items-center">
                        ...
                        <a href="{{route('dashboard')}}" class="media media-card align-items-center">
                            ...
                            <div class="media-body">
                                <h5 class="fs-15">شما برای یک شغل برنامه نویس فرانت اند درخواست دادید</h5>
                                <span class="d-block lh-18 pt-1 text-gray fs-13">12 خرداد 1400</span>
                            </div>
                        </a>
                        <a href="{{route('dashboard')}}" class="media media-card align-items-center">
                            ...
                            <div class="media-body">
                                <h5 class="fs-15">دوره شما با موفقیت آپلود شد</h5>
                                <span class="d-block lh-18 pt-1 text-gray fs-13">12 خرداد 1400</span>
                            </div>
                        </a>
                    </div>
