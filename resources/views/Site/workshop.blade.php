...
{{--                            <h3 class="widget-title">کارگاه های محبوب</h3>--}}
                                ...
                                <div class="col-lg-4 col-md-4">
                                    <div class="single-blog-post">
                                        ...
                                        <div class="post-content">
                                            <h3><a href="{{url('حوزه-علمیه-خواهران/معاونت-پژوهش/کارگاه-ها/'.$post->slug)}}">{{$post->title}}</a></h3>
...
{{--                                                    <h6>فاطمه محمدی</h6>--}}
                                                ...
                                                <div class="details-btn">
                                                    <a href="{{url('حوزه-علمیه-خواهران/معاونت-پژوهش/کارگاه-ها/'.$post->slug)}}"><i class="bx bx-left-arrow-alt"></i></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
