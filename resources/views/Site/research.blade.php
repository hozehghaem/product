...
@section('main')
    ...
    <div
        ...
        <section class="d-flex flex-column col-lg-9 align-self-center">
            <span class="my-4 col-lg-12"
                  style="text-align: justify;justify-content: center;align-content: center;align-self: center">{!! $contents->description !!}      </span>
            <img src="{{asset($contents->image)}}" class="my-3 d-flex flex-row" alt="">
        </section>
        <section class="d-flex flex-column col-lg-9 align-self-center">
            <span class="my-4 col-lg-12"
                  style="text-align: justify;justify-content: center;align-content: center;align-self: center">{!! $contents->description2 !!}      </span>
            <img src="{{asset($contents->image2)}}" class="my-3 d-flex flex-row" alt="">
        </section>
        <section class="d-flex flex-column col-lg-9 align-self-center">
            <span class="my-4 col-lg-12"
                  style="text-align: justify;justify-content: center;align-content: center;align-self: center">{!! $contents->description3 !!}      </span>
