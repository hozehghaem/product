        ...
        <div class="container-fluid">
            <div class="inner-body">
                <div class="page-header">
                    <div>
                        <h2 class="main-content-title tx-24 mg-b-5">مدیریت دسترسی</h2>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{url('admin/panel')}}">صفحه اصلی</a></li>
                            <li class="breadcrumb-item"><a href="{{url('admin/permissions')}}"> مدیریت دسترسی</a></li>
                                        ...
                                        <div class="row row-sm">
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="title" id="title" data-required="1" value="{{$permission->title}}" class="form-control" />
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="slug" id="slug" data-required="1" value="{{$permission->slug}}" class="form-control" />
                                                </div>
                                            </div>
