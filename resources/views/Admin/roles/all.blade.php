                        ...
                        <div class="card custom-card overflow-hidden">
                            <div class="card-body" style="background-color: #0000000a;border-radius: 10px 10px 0px 0px;">
                                <div class="row">
                                    ...
                                    <div class="col text-left"><a href="{{url(request()->segment(1).'/'.request()->segment(2).'/'.'create')}}" class="btn btn-primary btn-xs">+ افزودن نقش داشبورد</a></div>
                                </div>
                            </div>
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <div class="table-responsive">
                                        <style>
                                            ...
                                            table td {max-width: 300px !important;overflow: auto !important;}
                                        </style>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            var table = $('.yajra-datatable').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{ route('role-dashboard.index') }}",
