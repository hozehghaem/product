...
@section('main')
    ...
    @foreach($subestelams as $subestelam)
        <div id="myModal{{$subestelam->id}}" class="modal fade" role="dialog">
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" id="deletesubestelam{{$subestelam->id}}" class="btn btn-danger" data-id="{{$subestelam->id}}" data-dismiss="modal">بله</button>
                    </div>
                </div>
    ...
    @foreach($subestelams as $subestelam)
        <script>
            jQuery(document).ready(function(){
                jQuery('#deletesubstelam{{$subestelam->id}}').click(function(e){
                    e.preventDefault();
                    $.ajaxSetup({
                        headers: {
