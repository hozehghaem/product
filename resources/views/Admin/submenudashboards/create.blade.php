                                    ...
                                    <div class="row row-sm">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="title" id="title" data-required="1" placeholder="نام زیرمنو داشبورد را وارد کنید" class="form-control" />
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <p class="mg-b-10">لیبل زیرمنو داشبورد</p>
                                                <input type="text" name="label" id="label" data-required="1" placeholder="لیبل زیرمنو داشبورد را وارد کنید" class="form-control" />
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <p class="mg-b-10">کلاس زیرمنو داشبورد</p>
                                                <input type="text" name="class" id="class" data-required="1" placeholder="کلاس زیرمنو داشبورد را وارد کنید" class="form-control" />
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <p class="mg-b-10">کنترلر زیرمنو داشبورد</p>
                                                <input type="text" name="controller" id="controller" data-required="1" placeholder="کلاس زیرمنو داشبورد را وارد کنید" class="form-control" />
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
