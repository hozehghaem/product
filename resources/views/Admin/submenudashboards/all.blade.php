...
@section('main')
                    ...
                    <div class="col-lg-12">
                        <div class="card custom-card overflow-hidden">
                            <div class="card-body" style="background-color: #0000000a;border-radius: 10px 10px 0px 0px;">
                                <div class="row">
                                    <div class="col"><a href="{{url()->current()}}" class="btn btn-link btn-xs">لیست زیر منوهای داشبورد</a></div>
                                    <div class="col text-left"><a href="{{url(request()->segment(1).'/'.request()->segment(2).'/'.'create')}}" class="btn btn-primary btn-xs">+ افزودن زیر منو داشبورد</a></div>
                                </div>
                            </div>
                            <div class="card-body">
    ...
    @foreach($submenudashs as $submenupanel)
        <div id="myModal{{$submenupanel->id}}" class="modal fade" role="dialog">
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" id="deletesubmenu{{$submenupanel->id}}" class="btn btn-danger" data-id="{{$submenupanel->id}} " data-dismiss="modal">بله</button>
                    </div>
                </div>
    ...
    @foreach($submenudashs as $submenupanel)
        <script>
            jQuery(document).ready(function(){
                jQuery('#deletesubmenu{{$submenupanel->id}}').click(function(e){
                    e.preventDefault();
                    $.ajaxSetup({
                        headers: {
                    ...
                    jQuery.ajax({
                        url: "{{ route('deletesubmenudashboards') }}",
                        method: 'delete',
                        data: {
                            "_token": "{{ csrf_token() }}",
