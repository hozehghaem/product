                                    ...
                                    <div class="row row-sm">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="classcontroller" id="classcontroller"  value="{{$submenus->class}}" class="form-control" />
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
...
{{--                                                <div id="editor">--}}
{{--                                                    <p>{{$submenus->page_description}}</p>--}}
{{--                                                </div>--}}
                                                <textarea name="page_description" id="editor" class="form-control" cols="30" rows="4">{{$submenus->description}}</textarea>
                                            </div>
                                        </div>
    ...
    <script>
        jQuery(document).ready(function(){
            jQuery('#submit').click(function(e){
                ...
                var ckeditorValue = CKEDITOR.instances.editor.getData();
                ...
                jQuery.ajax({
                    ...
                    data: {
                        ...
                        page_description : ckeditorValue,
