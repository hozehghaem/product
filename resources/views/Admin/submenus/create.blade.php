                                    ...
                                    <div class="row row-sm">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <select name="footer_show" id="footer_show" class="form-control select-lg select2">
                                                    <option value="">انتخاب کنید</option>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <p class="mg-b-10">نام کلاس کنترلر</p>
                                                <input type="text" name="classcontroller" id="classcontroller" data-required="1" placeholder="نام کلاس کنترلر وارد کنید" class="form-control" />
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
    ...
    <script>
        jQuery(document).ready(function(){
            jQuery('#submit').click(function(e){
                ...
                let    footer_show      = jQuery('#footer_show').val();
                let    page_description = jQuery('#page_description').val();
                ...
                formData.append('footer_show'       , footer_show);
