...
@foreach($learnfiles as $learnfile)
    <div id="myModal{{$learnfile->id}}" class="modal fade" role="dialog">
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" id="deletelearnfile{{$learnfile->id}}" class="btn btn-danger" data-id="{{$learnfile->id}} " data-dismiss="modal">بله</button>
                </div>
            </div>
    ...
    @foreach($learnfiles as $learnfile)
        <script>
            jQuery(document).ready(function(){
                jQuery('#deletepost{{$learnfile->id}}').click(function(e){
                    e.preventDefault();
                    $.ajaxSetup({
                        headers: {
