                ...
                <div class="page-header">
                    <div>
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">تصاویر تامین کننده</li>
                        </ol>
                    </div>
                </div>
            </div>
                            ...
                            <div class="card-body">
                                <ul id="lightgallery" class="list-unstyled row mb-0">
                                    @foreach($medias as $media)
                                        <li class="col-xs-6 col-sm-4 col-md-4 col-xl-4 mb-3" data-responsive="{{asset($media->image)}}" data-src="{{asset($media->image)}}" >
                                            <img class="img-responsive" src="{{asset($media->image)}}">
                                        </li>
                                    @endforeach
                                </ul>
                            </div>
