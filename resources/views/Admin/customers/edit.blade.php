                    ...
                    <div class="col-lg-12 col-md-12">
                        <div class="card custom-card">
                            <div class="card-body" style="background-color: #0000000a;border-radius: 10px 10px 0px 0px;">
                                <div class="row">
                                    <div class="col"><a href="{{url()->current()}}" class="btn btn-link btn-xs">ویرایش اطلاعات همراهان</a></div>
...
{{--                                                @include('error')--}}
                                            ...
                                            <input type="hidden" name="priority_id" data-required="1" value="{{$customers->priority}}" class="form-control" />
                                            <div class="col-md-3">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group" >
                                                    ...
                                                    <textarea name="text" id="editor" cols="30" rows="5" class="form-control" >{{$customers->description}}</textarea>
                                                </div>
                                            </div>
