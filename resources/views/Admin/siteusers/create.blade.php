                                    ...
                                    <div class="row row-sm">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="name" id="name" data-required="1" placeholder="نام و نام خانوادگی را وارد کنید" class="form-control" />
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <p class="mg-b-10">نام کاربری</p>
                                                <input type="text" name="username" id="username" data-required="1" placeholder="نام کاربری را وارد کنید" class="form-control" />
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <p class="mg-b-10">آدرس ایمیل</p>
                                                <input type="text" name="email" id="email" data-required="1" placeholder="آدرس ایمیل را وارد کنید" class="form-control" />
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <p class="mg-b-10">شماره موبایل</p>
                                                <input type="text" name="mobile" id="mobile" data-required="1" placeholder="شماره موبایل را وارد کنید" class="form-control" />
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
