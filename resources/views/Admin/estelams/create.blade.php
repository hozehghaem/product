                                    ...
                                    <div class="row row-sm">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <p class="mg-b-10">عنوان فارسی استعلام</p>
                                                <input type="text" name="title_fa" id="title_fa" data-required="1" placeholder="عنوان فارسی استعلام" class="form-control" />
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <p class="mg-b-10">عنوان سیستمی استعلام</p>
                                                <input type="text" name="title" id="title" data-required="1" placeholder="title" class="form-control" style="direction: ltr;text-align: left" />
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <p class="mg-b-10">آدرس درخواست استعلام</p>
                                                <input type="text" name="action_route" id="action_route" data-required="1" placeholder="URL Action" class="form-control" style="direction: ltr;text-align: left" />
                                            </div>
                                        </div>
{{--                                        <div class="col-md-3">--}}
{{--                                            <div class="form-group">--}}
                ...
                swal({
                    ...
                    jQuery.ajax({
                        ...
                        data: {
                            ...
                            action_route     : jQuery('#action_route').val(),
                        },
