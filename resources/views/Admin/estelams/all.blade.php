...
@section('main')
                                ...
                                <div class="table-responsive">
                                    ...
                                    <table id="sample1" class="table table-striped table-bordered yajra-datatable">
                                        ...
                                        <tr>
                                            ...
                                            <th class="wd-10p"> عنوان استعلام </th>
                                            <th class="wd-10p"> عنوان استعلام فارسی </th>
                                            <th class="wd-10p"> آدرس روت </th>
    ...
    @foreach($stelams as $stelam)
        <div id="myModal{{$stelam->id}}" class="modal fade" role="dialog">
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" id="deletestelam{{$stelam->id}}" class="btn btn-danger" data-id="{{$stelam->id}}" data-dismiss="modal">بله</button>
                    </div>
                </div>
        ...
        $(function () {
            ...
            var table = $('.yajra-datatable').DataTable({
                ...
                columns: [
                    ...
                    {data: 'action_route'   , name: 'action_route'},
    ...
    @foreach($stelams as $stelam)
        <script>
            jQuery(document).ready(function(){
                jQuery('#deletestelam{{$stelam->id}}').click(function(e){
                    e.preventDefault();
                    $.ajaxSetup({
                        headers: {
