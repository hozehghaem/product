                                ...
                                <div class="table-responsive">
                                    ...
                                    <table id="sample1" class="table table-striped table-bordered yajra-datatable">
                                        ...
                                        <tr>
                                            ...
                                            <th class="wd-10p"> عنوان اعلان </th>
                                            <th class="wd-10p"> متن توضیحات اعلان </th>
                                            <th class="wd-10p"> سطح نمایش </th>
...
@foreach($notifs as $notif)
    <div id="myModal{{$notif->id}}" class="modal fade" role="dialog">
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" id="deletenotif{{$notif->id}}" class="btn btn-danger" data-id="{{$notif->id}} " data-dismiss="modal">بله</button>
                </div>
            </div>
    ...
    @foreach($notifs as $notif)
        <script>
            jQuery(document).ready(function(){
                jQuery('#deletenotif{{$notif->id}}').click(function(e){
                    e.preventDefault();
                    $.ajaxSetup({
                        headers: {
