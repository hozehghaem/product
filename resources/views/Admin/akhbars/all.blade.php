...
@foreach($akhbars as $akhbar)
    <div id="myModal{{$akhbar->id}}" class="modal fade" role="dialog">
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" id="deleteakhbar{{$akhbar->id}}" class="btn btn-danger" data-id="{{$akhbar->id}} " data-dismiss="modal">بله</button>
                </div>
            </div>
    ...
    @foreach($akhbars as $akhbar)
        <script>
            jQuery(document).ready(function(){
                jQuery('#deleteakhbar{{$akhbar->id}}').click(function(e){
                    e.preventDefault();
                    $.ajaxSetup({
                        headers: {
